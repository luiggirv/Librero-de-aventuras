...
public class GUIManager : MonoBehaviour 
{
    ...
    IEnumerator ShowMarkers(float showTime)
    {
        ...
        //Cualquier cosa con las indicacionesTXT eliminar este y el de abajo Markers[3]
        StartCoroutine(ScaleObject(markers[3], Vector2.one, 0.5f, 0));
        ...
        markers[3].localScale = Vector2.zero;
    ...
    IEnumerator ShowFinishScreen()
    {
        ...
        {
            StartCoroutine(ScaleObject(finishStars[i], new Vector2(0.5f, 0.5f), 0.4f, 0));
