...
public class LevelSelectMountain : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetInt("PuntajeMountain1", Restart.PuntajeLvl1);
            PuntajeReal1.GetComponent<Text>().text = Restart.PuntajeLvl1.ToString();
        ...
        {
            int puntaje1 = PlayerPrefs.GetInt("PuntajeMountain1");
            PuntajeReal1.GetComponent<Text>().text = puntaje1.ToString();
            Lock2.SetActive(false);
            Button2.GetComponent<Button>().interactable = true;

            PlayerPrefs.SetInt("PuntajeMountain2", Restart.PuntajeLvl2);
            PuntajeReal2.GetComponent<Text>().text = Restart.PuntajeLvl2.ToString();
        ...
        if (lvl3Superado == true)
        {
            ...
            int puntaje2 = PlayerPrefs.GetInt("PuntajeMountain2");
            PuntajeReal1.GetComponent<Text>().text = puntaje2.ToString();
            Lock3.SetActive(false);
            Button3.GetComponent<Button>().interactable = true;

            PlayerPrefs.SetInt("PuntajeMountain3", Restart.PuntajeLvl3);
            PuntajeReal3.GetComponent<Text>().text = Restart.PuntajeLvl3.ToString();
