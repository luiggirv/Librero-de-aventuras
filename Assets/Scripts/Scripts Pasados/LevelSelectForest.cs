...
public class LevelSelectForest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetInt("PuntajeForest1", GlobalTime.PuntajeLvl1);
            PuntajeReal1.GetComponent<Text>().text = GlobalTime.PuntajeLvl1.ToString();
        ...
        {
            int puntaje1 = PlayerPrefs.GetInt("PuntajeForest1");
            PuntajeReal1.GetComponent<Text>().text = puntaje1.ToString();
            Lock2.SetActive(false);
            Button2.GetComponent<Button>().interactable = true;

            PlayerPrefs.SetInt("PuntajeForest2", GlobalTime.PuntajeLvl2);
            PuntajeReal2.GetComponent<Text>().text = GlobalTime.PuntajeLvl2.ToString();
        ...
        if (lvl3Superado == true)
        {
            ...
            int puntaje2 = PlayerPrefs.GetInt("PuntajeForest2");
            PuntajeReal1.GetComponent<Text>().text = puntaje2.ToString();
            Lock3.SetActive(false);
            Button3.GetComponent<Button>().interactable = true;

            PlayerPrefs.SetInt("PuntajeForest3", GlobalTime.PuntajeLvl3);
            PuntajeReal3.GetComponent<Text>().text = GlobalTime.PuntajeLvl3.ToString();
