...
public class TestAventura2Bosque
{
    ...
    {
        //Se crea un objeto con la clase Artifact para que aparezca en el escenario
        ...
        //Se inicializan los parametros de la clase Artifact
        corral.GetComponent<Artifact>().health = 100;
        corral.GetComponent<Artifact>().maxHealth = 100;
        ...
        //Se crea un GameObject que contenga la clase Manager
        ...
        //Se inicializan los parametros de la clase Manager con tiempo inicial 60 segundos
        ...
        //Inicializamos al objeto animal "Wolf" para que ataque el corral
        ...
        //Guardamos el valor inicial de la vida del corral
        var oldHealth = corral.GetComponent<Artifact>().health;
        //Esperamos 5 segundos para que encuentre el corral y empiece a atacar
        yield return new WaitForSeconds(5);
        //Comprobamos que la vida del corral ha bajado por los ataques del animal
        Assert.IsTrue(oldHealth > corral.GetComponent<Artifact>().health);
    ...
    {
        //Se crea un objeto con clase Artifact para que aparezca en el escenario
        ...
        //Se crea la clase PauseMenuEcosistema para que aparezca en el escenario
        var pauseMenu = new GameObject();
        pauseMenu.AddComponent<PauseMenuEcosistema>();
        var pauseMenuUI = new GameObject();

        //Se inicializan los parametros de la clase PauseMenuEcosistema
    ...
    {
        //Se crea un objeto que contenga la clase Artifact para que aparezca en el escenario
        var corral = new GameObject();
        corral.AddComponent<Artifact>();
        var audioSource = new GameObject();
        audioSource.AddComponent<AudioSource>();
        ...
        //Se crea un GameObject que contenga la clase ScoreGlobalTower
        ...
        //Se inicializan los parametros de la clase ScoreGlobalTower
        ...
        //Se inicia el prefab Wolf para que busque el corral y ataque
        var animal = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Importaciones/TowerDefense/Prefabs/wolf3.prefab");
        animal = GameObject.Instantiate(animal, new Vector3(0, 0, 10), new Quaternion(0, 180, 0, 0));
